class Solution {
    ...
    public boolean validTree(int n, int[][] edges) {
        // A valid tree has excactly n-1 edges. If it has more it must not be connected or have a
        // cycle With n-1 edges are still need to check for connectivity though.
        if (edges.length != n - 1) {
            return false;
        }
